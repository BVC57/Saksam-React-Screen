...
useEffect(() => {
  ...
  const setDataLabels = (data) => {
    ...
    if (data !== null && data !== undefined && data.data !== null && data.data !== undefined) {
      setnewdatetime(data.data.education.updated_date);
...
// Check Driving License data
      ...
      if (
        ...
        if (
          ...
          console.error("driving lincense  image not found in the API response.");
        }
      }
...
if (
  ...
  data.data.employment.forEach((employment, index) => {
    // Set label data for each qualification
    setLabelData(
      `Job-Name-label-${index}`,
      employment.dept || "-"
    );
    setLabelData(
      `Company-Name-label-${index}`,
      employment.emp || "-"
    );
    setLabelData(
    ...
    setLabelData(`Expriance-label-${index}`,employment.tt_exp_yr || "-");
     // Set drivinglicence image
     if (
      data.data.employment &&
      data.data.employment.length > 0 &&
      ...
      <div className="apd">
            ...
            <div
              ...
              <div className="card">
                <div className="cardinfo">
                  ...
                  <p>Address:</p>
                  <label htmlFor="aadhar-address-label" id="aadhar-address-label">
                    -
                  </label>
                  <p>Date Of Birth:</p>
                  ...
                  <div className="aadhar-gender">
                    <label htmlFor="aadhar-gender-label" id="aadhar-gender-label">
                      -
                    </label>
                  </div>
                </div>
              ...
              <div className="upbyadhar">
                <p id="upbyadhar">
                  Added {newdatetime} / By Aadhar API
                </p>

                <p id="upbyzoop">
                  Latest verification Date {newdatetime} / By Zoop API
                </p>
              </div>
            </div>
        ...
        {/* PAN Card */}
            <div
              ...
              <div className="upbyadhar">
                <p id="upbyadhar">
                  Added On {newdatetime} / By Aadhar API
                </p>
      ...
      <h2>Identity</h2>
        {/* EDUCATIONAL QUALIFICATIONS */}
          <div className="MainCard">
            <h2 className="eq">EDUCATIONAL QUALIFICATIONS</h2>
            {eqDataPresent &&
              data.data.employment &&
                ...
                <div className="mcard" key={index}>
                  <div className="card">
                    <div className="cardinfo">
                      ...
                      <label htmlFor={`Institution-Name-label-${index}`}>
                        {education.ints_clg_sc || "-"}
                      </label>
                      <p>Degree Name:</p>
                      <label htmlFor={`Degree-Name-label-${index}`}>
                        {education.mj_cour_dg || "-"}
                      </label>
                      <p>Year Of Passing:</p>
                      <label htmlFor={`Year-Of-Passing-label-${index}`}>
                        {education.end_year || "-"}
                      </label>
                      <p>Honors:</p>
                  ...
                  <div className="upbyadhar">
                    ...
                    <p id="upbyzoop">
                      Latest verifation date {education.updated_date} / By Zoop API
                    </p>
                  </div>
                  <hr />
                </div>
              ...
              data.data.employment.map((employment, index) => (
                <div className="mcard" key={index}>
                  <div className="card">
                    <div className="cardinfo">
                      <p>Job Title:</p>
                      <label htmlFor={`Job-Name-label-${index}`}>
                        {employment.dept || "-"}
                      </label>
                      <p>Company Name:</p>
                      <label htmlFor={`Company-Name-label-${index}`}>
                        {employment.emp || "-"}
                      </label>
                      <p>Duration:</p>
                      <label htmlFor={`Duration-label-${index}`}>
                        {employment.end_date || "-"}
                      </label>
                      <p>Expriance:</p>
                      <label htmlFor={`Expriance-label-${index}`}>
                        {employment.tt_exp_yr || "-"}
                      </label>
                    </div>
                    <div className="image-container">
                  ...
                  <div className="upbyadhar">
                    ...
                    <p id="upbyzoop">
                      Latest verifation date {employment.updated_date} / By Zoop API
                    </p>
                  </div>
                  <hr />
                </div>
        ...
        {/* EDUCATIONAL CERTIFICATIONS */}
            {/* <div
              ...
              <div className="upbyadhar">
                ...
                <p id="upbyzoop">
                Latest verifation Date {newdatetime} / By Zoop API
                </p>
              </div>
            </div> */}
